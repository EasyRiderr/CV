...
% personal data
\name{Yoan}{Dumas}
\title{Ingénieur en informatique embarquée} % optional
\address{5 place du marché aux choux}{67160 Wissembourg}{}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\cventry{
2013\\6 mois
\raisebox{-13mm}{\href{http://www.conti-online.com/www/automotive_de_en/}{\includegraphics[height=1.5cm]{Continental.png}}}
...
\cventry{
2010\\3 mois
\raisebox{-2mm}{\href{http://lecanape.ca/}{\includegraphics[width=2cm]{lecanape.png}}}
         }{Stagiaire développement Web}{\href{http://lecanape.ca/}{Le canapé}}{Rouyn-Noranda}{Canada}{Développement PHP, HTML et SQL de sites web des clients.}

\section{Formation}
\cventry{2010--2013}{Diplôme d’ingénieurs en informatique}{\href{http://www.isima.fr/}{ISIMA (Institut Supérieur
d’Informatique de Modélisation et de leurs Applications})}{Clermond-Ferrand}{}{Filière
informatique des systèmes embarqués.}  % arguments 3 to 6 can be left empty
\cventry{2008--2010}{Diplôme Universitaire et Technologique en informatique}{\href{http://www.iut-rodez.fr/}{IUT de Rodez}}
{Rodez}{}{}
\cventry{2008}{Baccalauréat S}{Lycée Jean Jaurès}{Saint Affrique}{}{Option Sciences de l'Ingénieur}

\section{Connaissances}
\cvdoubleitem{Langages}{\emph{C}, C++, Qt, Java, Scala, Matlab, LabView, MatLab, VHDL, SystemC.}
             {Langues}{
						 \begin{itemize}
						     \item Français natal.
						     \item \emph{Anglais} courant (TOEIC 865).
						 \end{itemize}
						 }
\cvdoubleitem{Logiciels}{vim, Eclipse, Geany, Qt Creator, git, gcc, g++, ddd, Simulink, AMESim, SCADE Suite, Android SDK}
             {Modélisation}{
\begin{itemize}
\item Merise
\item UML
...
\cvitem{Projets}{
\begin{itemize}
\item Envoyer les données GPS d'une moto en WiFi en \emph{temps réel} sur RASPBERRY PI en \emph{Java}.
...
\cvitem{Sports}{Vélo (DH,  VTT), natation, course à pied, randonnée en montagne.}
\cvitem{Autres}{Sports mécaniques, musique.}
\end{document}